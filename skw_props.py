...
SURFACE_DEFORM_METHODS = [
    ('BLENDER', 'Blender', "Standard Blender's Surface Deform Modifier", 1),
    ('SQUEEZY_PIXELS', 'Squeezy Pixels', "Custom Surface Deform Modifier by Squeezy Pixels (Mykyta Petrenko)", 2)
]
...
class SKW_Property(bpy.types.PropertyGroup):
    ...
    surface_deform_method: bpy.props.EnumProperty(
        items=SURFACE_DEFORM_METHODS,
        name='Surface Deform Method',
        description='Method used for transferring shape keys (Surface Deform)',
        default='BLENDER'
    )
